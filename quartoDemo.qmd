...
![](figures/cu.jpg){.absolute top="170" left="30" width="400"}

![](figures/cmu.jpg){.absolute .fragment top="150" right="80" width="450"}

![](figures/csu.jpg){.absolute .fragment bottom="40" left="50" width="500"}

![](figures/smu.jpg){.absolute .fragment top="120" right="50" width="500"}
![](figures/tamu.jpg){.absolute .fragment bottom="0" left="0" width="600" }
