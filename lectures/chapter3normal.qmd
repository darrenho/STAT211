...
```{=html}
<img src="figures/appletScott.png" style="width:375.0%" alt="Screenshot of web applet for computing probabilities and values from the normal and t distribution" class="r-stretch quarto-figure-center"><p class="caption">Optional Applet</p>
```
