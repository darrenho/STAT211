...
We found that for a particular value $x = 4$, what is the probability $P(X \leq 4)$ is:
...
Now, let's ask the **opposite** question: for a particular probability $p$, what is the value $P(X \leq x) = p$
. . .
...
This is called a [quantile]{.definition} of the normal a corresponds to a particular value $x$
