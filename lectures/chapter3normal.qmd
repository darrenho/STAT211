...
![](figures/steelRuler.png){width="250%" fig-alt="Measuring to a shoulder on a machined part with a steel rule"}


We are measuring a standard inch using a ruler on a .01" scale
...
$Y = 2.54X$, therefore $Y \sim N(2.54,  2.54^2*.00005) = N(2.54,  0.00032)$
