...
![moo](figures/appletScott.png){fig-align="left" width="100%" fig-alt="Screenshot of web applet for computing probabilities and values from the normal and t distribution"}
