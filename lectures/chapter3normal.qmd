...
## Computing probabilities: old vs. new  {.scrollable}
...
moo
![](figures/normalTable.png){width="300%" fig-alt="Standard Normal Table for getting probabilities from Z-scores"}
...
![](figures/appletScott.png){fig-align="left" width="100%" fig-alt="Screenshot of web applet for computing probabilities and values from the normal and t distribution"}
