...
<iframe data-external="1" src="https://onlinestatbook.com/stat_sim/sampling_dist/" width="1250" height="1250" style="border: 1px solid #ccc" frameborder=0></iframe>
...
plotids <- plot3d(fXY, xlim=c(-.1,1), ylim = c(-.1,1),
...
The z-score for men is `r round(zScoreM,3)` while for women it is `r round(zScoreW,3)`
:::::::
...
We found the female z-score = $\frac{10.61 - 10.83}{\sqrt{.0049}}$ = `r round(zScoreW,3)`
...
## A (potentially) helpful applet {.nostretch}
