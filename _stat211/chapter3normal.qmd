...
## Transforming Normals: $aX + b$ {.scrollable #transformingNormals}
...
When $\mu=0$ and $\sigma=1$, we call it the 
...
$$
[(this is using the results @transformingNormals "Transforming Normals")]
<!--
\begin{figure}
