...
[Example:]{.example} We want to compare olympic records in men's sprinting  and women's sprinting
...
Hence, the women's result is more extreme as:
...
This is the [empirical rule:]{.definition})]{.subscript}

-   [$P( |Z| \leq 1) = 0.683$]{.lightbluetext}. ($\sim \frac{2}{3}$ prob. within 1 $\sigma$)
-   [$P( |Z| \leq 2) = 0.954$]{.lightgreentext} ($\sim \frac{19}{20}$ prob. within 2 $\sigma$)
-   [$P( |Z| \leq 3) = 0.997$]{.lightredtext} ($\sim \frac{99}{100}$ prob. within 3 $\sigma$)
